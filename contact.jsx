...
//     try {
//       const response = await fetch(HOST_API+"/contacts?populate=*");
...
//               SUPPORT <br /> {content[0]?.attributes?.heading_one}
//             </h4>
...
function Contact() {
  ...
  return (
    <>
      {/* Contact Info Start */}
      {content.length > 0 && content[0] && content[0].attributes && (
        <section className="contact-info">
          <div className="container">
            <div className="row">
              <div className="col-xl-4 col-lg-4">
              ...
              <div className="col-xl-4 col-lg-4">
                ...
                <div className="contact-info__single contact-info__single-3">
                  ...
                  <p className="contact-info__email-phone">
                    ...
                    <a href="" className="contact-info__phone">
                    {content[0].attributes.mobile}
                    </a>
                    <a
                      href="mailto:support@supportstreetchildren.org"
                      className="contact-info__email"
                    >
                      {content[0].attributes.email}
                    </a>
                  </p>
                </div>
              </div>
                ...
                <div className="contact-page__form">
                  ...
                  >
                    <div className="row">
                      ...
                      {/* Repeat input fields for name, email, phone, website, and address */}
                    </div>
                    <div className="row">
                      <div className="col-xl-12">
                        <div className="comment-form__input-box text-message-box">
