          ...
          <div className="gallery-list">
            <div className="gallery-box">
              <figure id="lightGallery3">
                <Link
                  href="assets/images/gallery/Support-from-Sanjay-Dutt/1.jpg"
                  data-fancybox-group="gallery"
                >
                  <img
                    className="img-responsive"
                    src="assets/images/gallery/Support-from-Sanjay-Dutt/1.jpg"
                    alt=""
                  />
                </Link>
                <Link
                  href="assets/images/gallery/Support-from-Sanjay-Dutt/2.jpg"
                  data-fancybox-group="gallery"
                >
                  {" "}
                </Link>
